...
**If installed manually to a project's `.claude/skills`**, add this to the project's
`.claude/settings.json` instead, using `$CLAUDE_PROJECT_DIR` so the command resolves
