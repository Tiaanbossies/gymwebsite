...
#
# Hook config (in .claude/settings.json for a project-level install; use
# ~/.claude/settings.json with the ~/.claude/skills/... path for a user-level install):
# {
#   "hooks": {
#     "Stop": [{
#       "matcher": "*",
...
# Extracted skills saved to: ~/.claude/skills/learned/ by default (override via config.json learned_skills_path)
