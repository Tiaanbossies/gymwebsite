...
**Results cache:** `.claude/skills/skill-stocktake/results.json` (or `~/.claude/skills/skill-stocktake/results.json` for a user-level install)
...
`.claude/skills/skill-stocktake/results.json` (or `~/.claude/skills/skill-stocktake/results.json` for a user-level install):
