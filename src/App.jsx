...
export default function App() {
  ...
  useEffect(() => {
    const meta = {
      ...
      '/services':   { title: "Personal Training & Open Gym in Centurion | Bossie's Gym", desc: "1-on-1 personal training, open gym access, nutrition coaching and body assessments at Bossie's Gym in Centurion.", image: `${SITE_ORIGIN}/images/gym/floor-hero.webp`, imageWidth: '1920', imageHeight: '1080' },
      '/membership': { title: "Gym Membership — Open Gym & PT in Centurion | Bossie's Gym", desc: "Personal training, monthly / 6-month / 12-month open gym contracts, R100 day passes, free trial and student & pensioner discounts." },
